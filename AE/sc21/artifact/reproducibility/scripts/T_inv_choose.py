...
App_Name={'0':'uts','1':'heatIR','2':'miniFE','3':'HPCCG','4':'sorIR','5':'amg','6':'heat','7':'heatRR','8':'sor','9':'sorRR'}
...
if(len(sys.argv) > 4):
    app_id=int(sys.argv[4])
    print("Benchmark Name: " , Bench_Name[App_Name[str(app_id)]])
T_inv=[]
Energy=[]
Time=[]
...
for sub_dir_path in dir_name:
	...
	file_list.sort()
	#print(file_list)
	Geo_Energy , Geo_Time = Execution(file_list,app_id);

...
void get_parameters(int argc, char** argv, Parameters& params)
{
 ...
 // params.nz = Mantevo::parse_parameter<int>(argstring, "nz", params.ny);
  params.nx = Mantevo::parse_parameter<int>(argstring, "nx", 256);
  params.ny = Mantevo::parse_parameter<int>(argstring, "ny", 512);
  params.nz = Mantevo::parse_parameter<int>(argstring, "nz", 512); 
